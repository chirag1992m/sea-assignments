...
python -m assignment3.coordinator --mapper_path=assignment4/mr_apps/idf_mapper.py --reducer_path=assignment4/mr_apps/idf_reducer.py --job_path=assignment4/idf_jobs --num_reducers=1
